...
namespace Servitors40k
{
    ...
    public class Building_ServitorCreator : Building_Enterable, IThingHolderWithDrawnPawn, IThingHolder
    {
        ...
        private ServitorSpecializationDef chosenSpecialization = null;
        ...
        public override void Tick()
        {
            ...
            if (Working)
            {
                ...
                if (PowerTraderComp.PowerOn && chosenSpecialization != null)
                {
                    TickEffects();
                    if (PowerOn)
                    {
        ...
        private void Finish()
        {
            ...
            if (servitor.apparel == null)
            {
                servitor.apparel = new Pawn_ApparelTracker(servitor);
            }
        ...
        public override IEnumerable<Gizmo> GetGizmos()
        {
            ...
            if (selectedPawn != null && ContainedPawn == null)
            {
                ...
                command_Action3.action = delegate
                {
                    ...
                    if (selectedPawn.CurJobDef == JobDefOf.EnterBuilding || selectedPawn.CurJobDef == JobDefOf.CarryToBuilding)
                    {
            ...
            else
            {
                if (chosenSpecialization == null)
                {
                    ...
                    if (!PowerOn)
                    {
                        command_Action5.Disable("NoPower".Translate().CapitalizeFirst());
                    }
        ...
        public override string GetInspectString()
        {
            ...
            if (Working && chosenSpecialization != null && ContainedPawn != null)
            {
                if (!text.NullOrEmpty())
                {
                    text += "\n";
            ...
            else if (innerContainer.Count == 0)
            {
                ...
                text += "WaitingToChooseSpecialization".Translate().Resolve();
            }
